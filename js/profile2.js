        ...
        <div id="profil-container">
            ...
            ${szekció(ICON.lock, 'Jelszó megváltoztatása', `
                <form class="szekció-grid" id="password-form">
                    ...
                    ${buildPasswordField('confirm-password', 'Jelszó megerősítése *', 'Jelszó megerősítése', true)}
                    <div style="display:flex;justify-content:flex-end;margin-top:0.25rem">
                        <button type="submit" id="password-submit-btn" class="btn-mentés" disabled>Jelszó módosítása</button>
                    </div>
